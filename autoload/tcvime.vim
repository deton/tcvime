...
function! tcvime#hira2kata(str)
  ...
  return join(hira, '')
  " XXX: vim‚ªÄ‹A“I‚È:s\=‚É–¢‘Î‰‚È‚Ì‚ÅAtcvime#ConvertOpKatakana()‚©‚çA
  "      \=tcvime#hira2kata()‚ÅŒÄ‚Ño‚·‚Æ“®‚©‚È‚¢B
  " return substitute(a:str, '.', '\=tcvime#hira2kata_char(submatch(0))', 'g')
endfunction

" 1•¶š‚ğƒJƒ^ƒJƒi‚É•ÏŠ·‚·‚é
...
function! s:ConvertOpKatakanaSub(beg, end)
  ...
  call cursor(0, col) " XXX: undo‚·‚é‚Æs“ª‚ÉˆÚ“®‚·‚é‚Ì‚Å‚¢‚Ü‚¢‚¿
endfunction
