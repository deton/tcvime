...
"  imap:
"    '<Plug>TcvimeIFix'
"       Œğ‚º‘‚«•ÏŠ·: Œó•âŠm’èƒL[BÈ—ª’l: <Leader><CR>
...
function! s:InputConvert(katuyo)
  ...
  if len > 0
    ...
    if ncands > 0
      " TODO: ©“®ƒwƒ‹ƒvB‚Ç‚ÌŒó•â‚ª‘I‘ğ‚³‚ê‚½‚©æ“¾‚·‚é‚É‚Í?
...
function! s:ConvertCount(count, katuyo)
  ...
  if len > 0
    ...
    if ncands > 1
      ...
      " 'lines'‚æ‚è‘½‚¢‚ÆMoreƒvƒƒ“ƒvƒg•\¦‚É0”Ô–Ú‚ª‰æ–Ê‚Éû‚Ü‚ç‚È‚¢‚Ì‚ÅA
      " Œ©‚ê‚È‚­‚Ä‚à–â‘è‚È‚¢•¶š—ñ‚ğÅ‰‚É“ü‚ê‚Ä‚¨‚­BTODO:3‰æ–ÊˆÈã‚ ‚éê‡
      call insert(lst, '•ÏŠ·Œó•â:')
